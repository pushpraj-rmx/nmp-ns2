    ...
    <section id="crm-banner" class="crm-banner-section position-relative">
        ...
        <div class="container">
            <div class="crm-banner-content crm-headline pera-content position-relative">
                ...
                <p>
                We're a web development and design company in Dwarka Sector 7, Delhi, focused on helping businesses grow and reach their potential on the internet.
                </p>
                        ...
                        <div class="s2-feature_right">
                            <div class="s2-feature_list s2-grean wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>We develop and design responsive websites.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-purple wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>We offer the best web development services in Delhi</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-pink wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>To promote our website designs in Delhi, we use advertisements, SEO-friendly content, and other e-Commerce strategies.</p>
                                </div>
                            </div>
                            <!-- list item -->
                        </div>
                    ...
                    <div class="eg-funfact-content clearfix position-relative">
                        <div class="eg-funfact-text float-right wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>Keeping unbreakable relationships is our mission at NMP, and we have a dedicated team that delivers on our promises. We think your business partner to deliver more than what you expect.
                                </p>
                            </div>
                            <!-- /title -->
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        As a company, we take the time to learn and understand the objectives of our enterprise clients. The next step is to design a layout that appeals to the audience once we discover all the basic requirements.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Create and Convert
                                        </p>
                                        NMP website designing services begin the process of converting web designs into functional CMS platforms. The next step is to market the website using digital marketing services.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>How can
                                    <span>We Serve You Better?</span>
                                </h2>
                                <p>We provide website development services to millions of people in India. In terms of web design, we have a sufficient amount of experience and expertise. Whether it's promoting a client's service or selling their products, NMP knows how to taste success.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        <p class="sub-heading">
                                        Web Developer With Excellent Skills
                                        </p>
                                        As a web development agency in Dwarka, we hire developers with more than three years' experience. Providing an immense user experience is their expertise when it comes to coding a complete-scale website.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Maintenance & Quality Assurance
                                        </p>
                                        Keeping up with the pace of digital trends and time, we upgrade the quality of our clients' websites. As well as maintaining your website in a timely manner, we provide support and services.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>We Design and Develop
                                    <span>Websites Professionally</span>
                                </h2>
                                <p>With years of experience building custom websites, we know what it takes to make a good looking one.The goal of these services is to generate more leads for our business clients by generating more inquiries from customers.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        You can reach another level of the market by using creative ideas. Our digital marketing strategies are innovative, very well thought out, and unique. With us, you'll get mind-blowing ideas for enhancing your ongoing business.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Logo Design and Branding
                                        </p>
                                        Creating an eye-catching logo for your brand is one of the tasks that NMP can handle. A visitor should not leave your website once he arrives for his purpose.
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="ei-faq faq_bg">
                                    <div class="ei-faq-header" id="headingOne">
                                        ...
                                        What Approach Do You Follow To Make A Successful Website?
                                        </button>
                                    </div>
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                            Basically, we implement following 5 steps to create an extremely attractive website:<br>
                                            Data gathering from clients<br>
                                            Proper planning and ideas<br>
                                            Collecting ideas and designing<br>
                                            Development with SEO strategies<br>
                                            Review, correct and then, final launch<br>
                                        </div>
                                    </div>
                                </div>
                                <div class="ei-faq">
                                    <div class="ei-faq-header" id="headingtwo">
                                        ...
                                        Do You Create Websites For Startup Organizations?
                                        </button>
                                    </div>
                                    <div id="collapsetwo" class="collapse" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        Yes, we create websites for startup businesses and other brands from different domains. NMP website development agency in Delhi is not restricted to any field. We work for all for increasing their website traffic and hence, the revenue.
                                        </div>
                                    </div>
                                </div>
                                <div class="ei-faq">
                                    <div class="ei-faq-header" id="headingthree">
                                        ...
                                        Are There Any Extra Charges Involved In Website Maintenance?
                                        </button>
                                    </div>
                                    <div id="collapsethree" class="collapse" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        Well the answer to this is dependent upon the package that you have purchased from our website designing company in Dwarka Sector 7, Delhi. We have packages inclusive and exclusive of maintenance charges. So yaa, you might have to pay extra in case it is not involved in your package; otherwise not.
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="ei-faq">
