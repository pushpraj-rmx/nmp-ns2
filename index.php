...
<body class="app-eight-home">
					...
					<div class="eight-banner-content">
						<div class="banner-content-box appeight-headline pera-content">
							<h1 class="cd-headline clip is-full-width">
								<span style="color:#009cff; font-size:1.2rem"> India's Top Rated</span><br>Digital Marketing Company <br> For
								<span class="cd-words-wrapper">
									<b class="is-visible">SEO Services</b>
									<b>SMO Services</b>
									<b>Website Development</b>
								</span>
							</h1>
							<p>
								Experience top-tier digital marketing assistance and outshine your competitors with our premium services in India.
							</p>
							<div class="ei-banner-btn">
								<a href="#" id="openPopup"><i class="fas fa-power-off"></i> Start Now</a>
								<a href="#"><span>or</span> Get a free quote</a>
							</div>
							<div class="ei-banner-review pera-content ul-li">
								...
								<p>(If you don't believe us, <span>ask our clients</span>)</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="eight-banner-content">
						<div class="ei-banner-mbl-mockup wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms">
							<img src="assets/img/marketing-pana.png" alt>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="eight-section-title appeight-headline pera-content text-center">
				<span class="eg-title-tag">
					What We Do<i class="square-shape"><i></i><i></i><i></i><i></i></i>
				</span>
				<h2>Our
					...
					<div class="col-lg-4 col-md-6  wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								...
								<p>
									We excel at delivering cutting-edge search solutions to help our clients dominate the market.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								...
								<p>
									We help you make strategic marketing decisions and achieve your sales and marketing objectives.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
					...
					<div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								...
								<p>
									Accelerate your brand's growth through social digital marketing with our expert team.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
					...
					<div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								<h3>SEO Services</h3>
								<p>
									Experience a winning SEO strategy that drives leads, sales, and revenue for your business.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
					...
					<div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								...
								<p>
									Generate leads, stay updated, &amp; increase traffic with the help of NMPI. Strengthen connections with your key audiences.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
					...
					<div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="service_content_box relative-position">
							...
							<div class="service_text_box saas2-headline pera-content">
								...
								<p>
									We creatively identify and solve clients' problems by designing search engines and user-friendly websites that effortlessly attract users.
								</p>
								<div class="service_read_more text-left">
									<a href="%21.html#">Read More </a>
								</div>
	...
	<section id="feature-eight" class="feature-eight-section position-relative">
		<div class="container">
			<div class="eight-section-title appeight-headline pera-content text-center">
				...
				<p>
					Choose us for unmatched expertise, measurable outcomes, and a client-centric approach that propels your digital success.
				</p>
			</div>
			<!-- /title -->
			...
			<div class="eight-feature-content">
				<div class="row justify-content-md-center">
					<div class="col-lg-3 col-md-6  wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="eight-feature-box text-center position-relative">
							<div class="feature-icon8 position-relative">
								<img src="assets/img/victory.svg" alt style="width: 70px;">
								<span class="ei-icon-bg"></span>
							</div>
							<div class="feature-text8 appeight-headline pera-content">
								<h3>Expertise and Experience</h3>
								<p>
									Unleashing digital prowess and seasoned finesse to conquer your online goals.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="eight-feature-box text-center position-relative">
							<div class="feature-icon8 position-relative">
								<img src="assets/img/resultant.svg" alt style="width: 60px;">
								<span class="ei-icon-bg"></span>
							</div>
							<div class="feature-text8 appeight-headline pera-content">
								<h3>Tailored Strategies</h3>
								<p>
									Precision-crafted plans that elevate your brand and outshine competitors in the digital arena.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="900ms" data-wow-duration="1500ms">
						<div class="eight-feature-box text-center position-relative">
							<div class="feature-icon8 position-relative">
								<img src="assets/img/intergrated.svg" alt style="width: 70px;">
								<span class="ei-icon-bg"></span>
							</div>
							<div class="feature-text8 appeight-headline pera-content">
								<h3>Data-Driven Approach</h3>
								<p>
									Empowering decisions with analytics-driven precision, paving the way for triumphant digital campaigns.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 wow fadeFromUp" data-wow-delay="1200ms" data-wow-duration="1500ms">
						<div class="eight-feature-box text-center position-relative">
							<div class="feature-icon8 position-relative">
								<img src="assets/img/client-focused.svg" alt style="width: 70px;">
								<span class="ei-icon-bg"></span>
							</div>
							<div class="feature-text8 appeight-headline pera-content">
								<h3>Full-Service Solutions</h3>
								<p>
									Your one-stop destination for digital excellence, offering comprehensive solutions that propel your success.
								</p>
							</div>
						</div>
					</div>
	...
	<!-- Start of bullet point section -->
	<section id="xis-it-system-feature" class="xis-it-system-feature-section position-relative" data-background="assets/img/branding-banner.jpg" style="margin-bottom: 5rem;">
		<span class="xis-it-sf-shape1 position-absolute" data-parallax='{"x" : -150}'><img src="assets/img/it-solution/shape/sh1.png" alt></span>
		<span class="xis-it-sf-line-sh1 position-absolute" data-parallax='{"y" : -50}'><img src="assets/img/it-solution/shape/sh2.png" alt></span>
		<span class="xis-it-sf-line-sh2 position-absolute" data-parallax='{"y" : 10}'><img src="assets/img/it-solution/shape/sh3.png" alt></span>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="xis-it-system-feature-text-wrap xis-it-headline pera-content">
							<h3 class="wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">Brand
								Transformation with</h3>
							<h2 class="wow fadeFromUp" data-wow-delay="400ms" data-wow-duration="1500ms">The Best
								Digital Marketing Agency in India</h2>
							<p class="wow fadeFromUp" data-wow-delay="500ms" data-wow-duration="1500ms">We provide
								on-demand internet marketing services all over India for our clients. These services
								depend
								upon the company's domain, business size, professional's demand, and other factors too.
							</p>
							<div class="xis-it-btn wow fadeFromUp" data-wow-delay="500ms" data-wow-duration="1500ms">
								<a class="d-flex justify-content-center align-items-center" href="#">Discover More</a>
							</div>
						</div>
					</div>
					<div class="col-lg-5 wow fadeFromRight" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="xis-it-system-feature-list-wrap position-relative">
							<div class="xis-it-system-feature-list position-relative xis-it-headline ul-li" data-background="assets/img/it-solution/bg/ft-shape1.png">
								<h3>NMPI Features</h3>
								<ul>
									<li>Achieve a 100% increase in organic traffic </li>
									<li>Provide comprehensive online marketing solutions </li>
									<li>Elevate brand design and optimization </li>
									<li>Employ strategic approaches to deliver world-class services</li>
									<li>Offer the best website development and design services</li>
									<li>Proudly awarded by Skill India for our expertise</li>
									<li>Backed by a 45-Day Money-Back Guarantee</li>
								</ul>
							</div>
							<div class="appoint-btn text-center">
								<a class="d-flex justify-content-center align-items-center show-modal">Make an
									Appointment
	...
	============================================= -->
	<section id="xis-dia-skill" class="xis-dia-skill-section" data-background="assets/img/digital_f/bg/skill-bg.png" style="margin-bottom: 7rem;">
		<div class="container">
			<div class="eight-section-title appeight-headline pera-content text-left text-center">
				<span class="eg-title-tag">
					Our Skills<i class="square-shape"><i></i><i></i><i></i><i></i></i>
				</span>
				<h2>Hire Best Digital Marketing Company
					<span>That Wins Visitors</span>
				</h2>
			</div>
			<div class="xis-dia-skill-content">
				<div class="xis-dia-skill-img-progress d-flex  justify-content-end position-relative">
					...
					<div class="xis-dia-skill-text-progress">
						<div class="xis-dia-skill-text">
							Collaborate technical and talent with NMPI digital marketing company. Realize the power of
							the digital world to grow your business.
						</div>
						<div class="xis-dia-skill-progress">
							<div class="skill-progress-bar">
								...
								<div class="skill-set-percent">
									<h4>SEO Experts</h4>
									<div class="progress">
										<div class="progress-bar" data-percent="97"></div>
									</div>
								</div>
							</div>
						</div>
						<div class="xis-dia-btn">
							<a class="d-flex justify-content-center align-items-center text-uppercase" href="#">Start a
	...
	<style>
		...
		.process-step-number {
			background: linear-gradient(-45deg, #e511e6 32%, #6b2c94 100%);
			text-align: center;
			margin: 0 auto;
			color: #fff;
			height: 100%;
		...
		.process-point-right {
			...
			height: 25px;
			border-radius: 50%;
			border: 8px solid #e442ec;
			box-shadow: 0 0 0 4px #6b2c94;
			margin: auto 0;
			position: absolute;
			bottom: 60px;
			left: -60px
		...
		.process-step-number:after {
			...
			border-bottom: 8px solid #e511e6;
			border-left: 8px solid #04889800;
			border-right: 8px solid #e511e6;
			display: inline-grid;
			position: absolute;
			left: -16px;
			top: 0
				...
				<div class="col-md-10 col-lg-9">
					<div class="section-heading text-center">
						<div class="eight-section-title appeight-headline pera-content text-left">
							<span class="eg-title-tag">
								Work Process<i class="square-shape"><i></i><i></i><i></i><i></i></i>
							</span>
							<h2>Unveiling the Journey:
								<span>NMPI's Dynamic Work Process</span>
							</h2>
						</div>
					</div>
				</div>
	...
	<!-- Start of How work  section
    	============================================= -->
	<!-- <section id="eg-how-work" class="eg-how-work-section position-relative" style="margin-bottom: 10rem;">
						...
						<div id="how-workscrollbar" class="how-work-scroller">
							<div class="eg-how-work-content">
								...
								<div class="eg-how-work-icon-text position-relative">
									...
									<div class="eg-how-work-text appeight-headline pera-content">
										<h3>Actions</h3>
										<p>Keeping track of/adjusting the implementation schedule for resources
											technology.</p>
									</div>
								</div>
							</div>
	...
	<!-- Start of service  section
    	============================================= -->
	<section id="eight-service" class="eight-service-section position-relative" style="margin-top: 10rem;">
		<div class="container">
						...
						<a class="pager" data-slide-index="0">
							<div class="ei-service-icon-text text-right appeight-headline pera-content">
								...
								<div class="ei-service-text">
									<h3>Marketing Reasearch</h3>
									<p>NMPI has a specialised team only for the marketing reaseach purposes. We don't
										rush on
										our project until we research about it very well. </p>
								</div>
							</div>
						</a>
						...
						<a class="pager" data-slide-index="1">
							<div class="ei-service-icon-text text-right appeight-headline pera-content">
								...
								<div class="ei-service-text">
									...
									<p>Our work strategy involves a meticulous analysis of your goals, audience, and
										market
										to
										drive focused campaigns.</p>
								</div>
							</div>
						</a>
						...
						<a class="pager" data-slide-index="2">
							<div class="ei-service-icon-text text-right appeight-headline pera-content">
								...
								<div class="ei-service-text">
									...
									<p>We continuously refine and optimize our strategies based on data insights,
										ensuring
										optimal performance and results..</p>
								</div>
							</div>
						</a>
					</div>
			...
			<div class="eight-service-text position-relative appeight-headline wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
				<!-- <div class="ei-service-slide-mbl" data-background="assets/img/strategy.svg">
				...
				<h2>What's NMPI Marketing Strategy?</h2>
			</div>
		</div>
	...
	<section id="ei-testimonial" class="ei-testimonial-section position-relative" data-background="assets/img/app-landing/background/tbg.jpg">
		<div class="container">
			<div class="eight-section-title appeight-headline pera-content text-center">
				...
				<h2>
					What Our Client <span>Say About NMPI</span>
				</h2>
			...
			<div class="ei-testimonial-content">
				<div id="testimonial-scroller" class="testimonial-scroller-area owl-carousel">
					<div class="ei-testimonial-img-text position-relative">
						...
						<div class="ei-testimonial-text">
							...
							<p>In order to generate advanced marketing strategies, we integrate our
								...
								strives to keep my organization at the top.</p>
							<div class="ei-testi-rate ul-li clearfix text-center">
								<ul>
									<li><i class="fas fa-star"></i></li>
									<li><i class="fas fa-star"></i></li>
									<li><i class="fas fa-star"></i></li>
					...
					<div class="ei-testimonial-img-text position-relative">
						...
						<div class="ei-testimonial-img float-left text-center">
							<img src="assets/img/testimonials/sophia.jpg" alt>
						</div>
						<div class="ei-testimonial-text">
							<div class="ei-testimonial-name appeight-headline pera-content">
								<h3>Sophia Garg</h3>
								<span>Founder & CEO Radiiantt Academy</span>
							</div>
							<p>Thanks, NMPI team for being promising and providing standard work
								quality at an affordable price. We could not be happier than ever with our attractive
								logo
								and website
								being designed by NMPI.
							</p>
							<div class="ei-testi-rate ul-li clearfix text-center">
								<ul>
									<li><i class="fas fa-star"></i></li>
					...
					<div class="ei-testimonial-img-text position-relative">
						...
						<div class="ei-testimonial-img float-left text-center">
							<img src="assets/img/testimonials/sunny.png" alt>
						</div>
						<div class="ei-testimonial-text">
							<div class="ei-testimonial-name appeight-headline pera-content">
								<h3>Sunny Khurana</h3>
								<span>Founder The Panipat Handlooms</span>
							</div>
							<p>NMPI digital marketing company begins with deep
								analysis and competitive sessions. I found it unique from all others
								available till today. NMPI helped me a lot in
								increasing my business. </p>
							<div class="ei-testi-rate ul-li clearfix text-center">
								<ul>
									<li><i class="fas fa-star"></i></li>
									<li><i class="fas fa-star"></i></li>
					...
					<div class="ei-testimonial-img-text position-relative">
						...
						<div class="ei-testimonial-img float-left text-center">
							<img src="assets/img/testimonials/kartik.jpg" alt>
						</div>
						<div class="ei-testimonial-text">
							<div class="ei-testimonial-name appeight-headline pera-content">
								<h3>Kartik Kaushik(Suneo)</h3>
								<span>Founder & CEO Kritika Events</span>
							</div>
							<p>In order to generate advanced marketing strategies, we integrate our
								creative ideas and technical abilities. Throughout the process, the team
								strives to keep my organization at the top.
							</p>
							<div class="ei-testi-rate ul-li clearfix text-center">
								<ul>
									<li><i class="fas fa-star"></i></li>
...
============================================= -->
					...
					<div class="eg-funfact-content clearfix position-relative">
						...
						<div class="eg-funfact-text float-right wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
							<div class="eight-section-title appeight-headline pera-content text-left">
								...
								<h2>Discover Fascinating Insights:
									<span>Intriguing Facts for Our Valued Clients</span>
								</h2>
								<p>From Search Engine Optimization to Website Development we have helped our client in
									every aspect and field.</p>
							</div>
							<!-- /title -->
							<div class="fun-fact-counter position-relative clearfix">
								<div class="eg-counter-number pera-content text-center">
									<span class="odometer" data-count="80">00</span><strong>+</strong>
									<p>Projects Delivered</p>
								</div>
								<div class="eg-counter-number pera-content text-center">
									<span class="odometer" data-count="73">00</span><strong>+</strong>
									<p>Happy Clients</p>
								</div>
								<div class="eg-counter-number pera-content text-center">
								...
								<div class="eg-counter-number pera-content text-center">
									<span class="odometer" data-count="65">00</span><strong>+</strong>
									<p>5 stars
										ratings</p>
								</div>
							</div>
	...
	<section id="ei-team" class="ei-team-section">
		<div class="container">
			<div class="eight-section-title appeight-headline pera-content text-center">
				...
				<p>With our years of experience, Our digital marketing company have the best digital marketers
					who can market your business on multiple online platforms.</p>
			</div>
			<!-- /title -->
			<div id="ei-team-slide" class="ei-team-content owl-carousel">
				<div class="ei-team-pic-text">
					<div class="ei-team-img position-relative">
						<div class="team-mem-img-ei text-center position-relative">
							<img src="assets/img/rajashukla.jpeg" alt>
				...
				<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="ei-team-img position-relative">
						<div class="team-mem-img-ei text-center position-relative">
							<img src="assets/img/swet.png" alt>
							<span class="mshape-bg shape-bg1"><img src="assets/img/app-landing/team/msbg1.png" alt></span>
							<span class="mshape-bg shape-bg2"><img src="assets/img/app-landing/team/msbg2.png" alt></span>
						</div>
						<div class="ei-team-social">
				...
				<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
					<div class="ei-team-img position-relative">
						<div class="team-mem-img-ei text-center position-relative">
							<img src="assets/img/ankit.png" alt>
							<span class="mshape-bg shape-bg1"><img src="assets/img/app-landing/team/msbg1.png" alt></span>
							<span class="mshape-bg shape-bg2"><img src="assets/img/app-landing/team/msbg2.png" alt></span>
						</div>
						<div class="ei-team-social">
				...
				<div class="ei-team-pic-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
					<div class="ei-team-img position-relative">
						<div class="team-mem-img-ei text-center position-relative">
							<img src="assets/img/ameer-deep.png" alt>
							<span class="mshape-bg shape-bg1"><img src="assets/img/app-landing/team/msbg1.png" alt></span>
							<span class="mshape-bg shape-bg2"><img src="assets/img/app-landing/team/msbg2.png" alt></span>
						</div>
						<div class="ei-team-social">
				...
				<div class="ei-team-pic-text">
					<div class="ei-team-img position-relative">
						<div class="team-mem-img-ei text-center position-relative">
							<img src="assets/img/pushpa.png" alt>
							<span class="mshape-bg shape-bg1"><img src="assets/img/app-landing/team/msbg1.png" alt></span>
							<span class="mshape-bg shape-bg2"><img src="assets/img/app-landing/team/msbg2.png" alt></span>
						</div>
						<div class="ei-team-social">
	...
	<script src="assets/js/it-solution.js"></script>
	...
	<script src="assets/js/rev-tools.js"></script>
	<script src="assets/js/rev.js"></script>
	<script src="assets/js/side-demo.js"></script>
	<script src="assets/js/it-source.js"></script>
	<script src="assets/js/digital-agency-4.js"></script>
...
<!-- Mirrored from html.themexriver.com/Saasio/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2023 06:11:34 GMT -->
