...
<head>
    <meta charset="UTF-8">
    <title>SaaSio - Service</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="https://nidmm.org/nmp-live/img/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="https://nidmm.org/nmp-live/img/favicon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="assets/css/it-solution.css">
    <link rel="stylesheet" href="assets/css/it-source.css">
    <link rel="stylesheet" href="assets/css/digital-agency-3.css">
...
<!-- HEADER STYLE FOR SERVICE ONLY  START-->
...
<!-- HEADER STYLE FOR SERVICE ONLY  END -->



    <style>
        .saasio-breadcurmb-section {
            background: linear-gradient(to right, #c12dd1bb, #6d8bf8c1), url(../../assets/img/app-landing/shape/s-shape2.png), url(../../assets/img/app-landing/shape/s-shape3.png);
        }
    </style>
    ...
    <section id="crm-banner" class="crm-banner-section position-relative">
        <div class="crm-banner-shape position-absolute crm-b-shape1"><img src="assets/img/crm/shape/bs1.png" alt="">
        </div>
        <div class="crm-banner-shape position-absolute crm-b-shape2"><img src="assets/img/crm/shape/bs2.png" alt="">
        </div>
        <div class="crm-banner-shape position-absolute crm-b-shape3"><img src="assets/img/crm/shape/bs3.png" alt="">
        </div>
        <div class="crm-banner-shape position-absolute crm-b-shape4"><img src="assets/img/crm/shape/bs4.png" alt="">
        </div>
        <div class="container">
            <div class="crm-banner-content crm-headline pera-content position-relative">
                <span>#1</span>
                <h1>Content Marketing Service Provider</h1>
                <p>NMPI is a leading provider of content marketing services in Delhi that help businesses connect with their target audience and drive revenue growth. With a team of experienced marketers and content creators, NMP offers a range of services that can be customized to meet the unique needs of each client.
                </p>
                <div class="crm-banner-subscribe position-relative">
                    <form action="#" method="post">
                        <input type="email" name="email" placeholder="Enter Email Address">
                        <button type="submit">Connect With Experts</button>
                    </form>
                </div>
            </div>
            <div class="crm-banner-vector position-absolute">
                <img src="assets/img/crm/shape/b-vector.png" alt="">
            </div>
        </div>
    </section>
    ...
    <section id="saas_two_feature" class="saas_two_feature_section s2-service-feed">
        <div class="container">
            <div class="s2-feature_content">
                <div class="row">
                    <div class="col-lg-6 col-md-12 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeFromUp;">
                        <div class="s2-feature_left">
                        <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Our work strategies
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>NMPI's 
                                    <span>Content Marketing Solutions</span>
                                </h2>
                                <p>Our solutions include content strategy development, content creation, content distribution, and content optimization. This comprehensive approach ensures that each piece of content is carefully crafted to meet the needs of the target audience and is distributed through the most effective channels.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="s2-feature_right">
                            <div class="s2-feature_list s2-grean wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>A well-crafted content strategy lays out the goals, audience, topics, formats, channels, and metrics of a business's content marketing efforts.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-purple wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeFromUp;">
                                <div class="s2-feature_icon text-center relative-position">
                                    <i class="fas fa-pen-square"></i>
                                </div>
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Content Creation</h3>
                                    <p>Content creation involves the development of blog posts, articles, social media posts, videos, images, infographics, and other types of content.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-pink wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeFromUp;">
                                <div class="s2-feature_icon text-center relative-position">
                                    <i class="fas fa-headphones"></i>
                                </div>
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Content Distribution</h3>
                                    <p>After content is created, it needs to be distributed to reach the target audience</p>
                                </div>
                            </div>
                            <!-- list item -->
                        </div>
                        ...
                        <div class="eg-funfact-text float-right wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Why NMPI is 
                                    <span>Best Content Marketing Company In Delhi</span>
                                </h2>
                                <p>NMPI is a top-rated content marketing company in Delhi that helps businesses of all sizes to enhance their content marketing efforts and achieve their marketing goals. Our company offers a comprehensive range of content marketing solutions that are designed to cater to the specific needs of each client.
                                </p>
                            </div>
                            <!-- /title -->
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        We can continually optimize content for better performance by testing different headlines, layouts, images, and calls-to-action. We also monitor metrics like engagement, traffic, and conversions to determine what's working and what's not.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Content Measurement and Analysis
                                        </p>
                                        We can measure and analyze the performance of content to determine its impact on the client's marketing goals. Metrics like engagement, traffic, and conversions can provide insights into what types of content are resonating with the target audience and driving results.
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- End of Fun fact  section
    	============================================= -->
    <!-- card section  -->
    <section id="ei-appdownload" class="ei-appdownload-section position-relative" data-background="assets/img/app-landing/background/appbg1.png" style="background-image: url(&quot;assets/img/app-landing/background/appbg1.png&quot;);">
		<div class="container">
			<div class="ei-appdownload-content">
				<div class="row">
					<div class="col-lg-6">
						<div class="ei-app-mockup-img  wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms;">
							<img src="assets/img/app-landing/mockup/amu1.png" alt="">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="ei-app-down-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms;">
							<div class="eight-section-title appeight-headline pera-content text-left">
								<span class="eg-title-tag">
									App Download<i class="square-shape"><i></i><i></i><i></i><i></i></i>
								</span>
								<h2>Request Free Quotes and
							...
							<div class="login-box">
								...
								<form>
									...
									<div class="user-box">
										<input type="email" name="" required="false">
										<label>Your Query</label>
									</div>
									<a href="#">
										<span></span>
		...
		<div class="ei-appdownloaad-shape app-shape1" data-parallax="{&quot;y&quot; : -100}" style="transform:translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); "><img src="assets/img/app-landing/background/apps1.png" alt=""></div>
		<div class="ei-appdownloaad-shape app-shape2" data-parallax="{&quot;x&quot; : -120}" style="transform:translate3d(-98.196px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(-98.196px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); "><img src="assets/img/app-landing/background/apps2.png" alt=""></div>
		<div class="ei-appdownloaad-shape app-shape3" data-parallax="{&quot;y&quot; : -100}" style="transform:translate3d(0px, -46.928px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, -46.928px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); "><img src="assets/img/app-landing/background/apps3.png" alt=""></div>
	</section>
...
============================================= -->
    <section id="app-edu-about" class="app-edu-about-section position-relative">
        <span class="app-edu-about-shape position-absolute"><img src="assets/img/education/ab-shape1.png" alt=""></span>
        <span class="app-edu-about-shape2 position-absolute"><img src="assets/img/education/ab-shape2.png" alt=""></span>
        <div class="container">
            <div class="app-edu-about-content">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="app-edu-about-img">
                            <img src="assets/img/education/ab-v.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Why Choose Our  
                                    <span>Content Marketing Services For Your Business</span>
                                </h2>
                                <p>Our content marketing services in India can help your business achieve success in its digital marketing efforts. By working with us, you can be confident that your content marketing efforts are aligned with your business objectives, targeted at your audience, and delivering measurable results.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        We take a comprehensive approach to content marketing that involves developing a content strategy, creating high-quality content, distributing it through various channels, optimizing it for better performance, and measuring and analyzing its impact on your marketing goals.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Customized Solutions
                                        </p>
                                        We understand that each business has unique content marketing needs, and we tailor our solutions accordingly. Our content marketing experts work closely with each client to develop a content strategy and create content that is relevant, engaging, and valuable to their target audience.
                                    </li>
                                </ul>
                            </div>
                        </div>
...
============================================= -->
    ...
    <!-- <section id="ei-newslatter" class="ei-newslatter-section position-relative">
        <div class="ei-newslatter-box position-relative">
            ...
            <div class="ei-news-vector1 position-absolute"><img src="assets/img/app-landing/shape/n-shape1.png" alt>
            </div>
            <div class="ei-news-vector2 position-absolute"><img src="assets/img/app-landing/shape/n-shape2.png" alt>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="client-section-heading">
                        <h4>Who are our happy with NMPI Services</h4>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="client-section-para">
                        <p>Global businesses are moving their work online and getting more profit than offline
                            services. So what are you waiting for? Contact NMPI digital marketing company and allow our
                            experts to help you in expanding your business all over world.
                        </p>
                    </div>
                </div>
                <div class="it-up-sponsor" class="it-up-sponsor-section" style="background: #fff; margin-left: 10%; margin-top: -3%; z-index: 0;">
                    <div class="container">
                        <div id="it-up-sponsor-slide" class="it-up-sponsor-slider owl-carousel">
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-01.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-02.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-03.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-04.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-05.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-06.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-07.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-08.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-09.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-10.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-11.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-12.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-13.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-14.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-15.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-16.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-17.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-18.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-19.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-20.png" alt>
                            </div>
                            <div class="it-up-sponsor-img">
                                <img src="assets/img/client-logo/client-21.png" alt>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Expert Content Marketing Team
                                    <span>Benefits of connecting NMPI</span>
                                </h2>
                                <p>Our expert team is dedicated to delivering high-quality content marketing solutions that drive results for our clients. By leveraging our experience, creativity, flexibility, communication skills, data-driven approach, and collaborative spirit, we can help businesses achieve success in their content marketing efforts.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        Our team has extensive experience in content marketing and has worked with a variety of clients across different industries. We understand the latest trends and best practices in the industry and leverage our experience to create effective content marketing solutions.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Creativity
                                        </p>
                                        Our team is highly creative and has a keen eye for design and visual aesthetics. We create engaging and visually appealing content that stands out from the competition.
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<section id="saas_two_service" class="saas_two_service_section">
        <div class="container">
            <div class="eight-section-title appeight-headline pera-content text-center">
				<span class="eg-title-tag">
					Our Services<i class="square-shape"><i></i><i></i><i></i><i></i></i>
				</span>
				<h2>Introducing a Diversity of
					<span>Internet Marketing Services</span>
				</h2>
			</div>
            <!-- /section title -->
                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-4 col-md-6  wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="service_content_box relative-position">
                            ...
                            <div class="service_text_box saas2-headline pera-content">
                                <h3><a href="#"> Faster docs. Faster deals</a></h3>
                                <p>Get your documents out the door fast to keep deals with automatic notifications,
                                    on-the-fly editing, and integrated.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /service-content -->
                    <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="service_content_box relative-position">
                            <div class="service_icon_box relative-position">
                                ...
                                <div class="lower_icon">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M0,45.511V307.2h512V45.511H0z M221.176,96.021l24.136,24.136l-45.511,45.511l-24.136-24.136L221.176,96.021z M290.823,256.69l-24.136-24.136l45.511-45.511l24.136,24.136L290.823,256.69z M199.801,256.69l-24.136-24.136L312.198,96.021 l24.136,24.136L199.801,256.69z" />
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <polygon points="512,398.222 512,341.333 0,341.333 0,398.222 182.044,398.222 182.044,432.356 108.089,432.356 108.089,466.489 403.911,466.489 403.911,432.356 329.956,432.356 329.956,398.222 " />
                                            </g>
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <div class="service_text_box saas2-headline pera-content">
                                <h3><a href="#">UI/UX design based app</a></h3>
                                <p>Whether you have a team of 2 or 200, the Mailboxes keep everyone the same page.
                                    Leverage automation to move fast.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /service-content -->
                    <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="service_content_box relative-position">
                            <div class="service_icon_box relative-position">
                                ...
                                <div class="lower_icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M437.4,95.856L437.4,95.856L512,21.277L490.79,0.06L416.289,74.54H93.872V10.669H63.871V74.54H0v30.001h63.871v343.528 h343.528v63.871H437.4v-63.871h63.871v-30.001H437.4V95.856z M93.872,104.542h292.407L93.872,396.864V104.542z M407.4,418.069 h-0.001H115.096L407.4,125.85V418.069z">
                                                </path>
                            ...
                            <div class="service_text_box saas2-headline pera-content">
                                <h3><a href="#">Build designs that scale</a></h3>
                                <p>Lay the foundations for your product’s design system with reusable, responsive
                                    components that automatically scale.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /service-content -->
                    <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="service_content_box relative-position">
                            <div class="service_icon_box relative-position">
                                <div class="upper_icon">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.002 512.002" xml:space="preserve">
                                        <g>
                                            <g>
                            ...
                            <div class="service_text_box saas2-headline pera-content">
                                <h3><a href="#">Customise your workflow</a></h3>
                                <p>Choose from hundreds of plugins and integrations that let you do everything from
                                    animating interactions.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /service-content -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="service_content_box relative-position">
                            <div class="service_icon_box relative-position">
                                <div class="upper_icon">
                                    <svg height="504pt" viewBox="0 0 504.10605 504" width="504pt" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="m367.089844 81.28125-130.6875 130.6875c-2.179688 2.105469-3.054688 5.226562-2.289063 8.160156.769531 2.9375 3.0625 5.226563 5.996094 5.996094s6.054687-.105469 8.164063-2.289062l130.683593-130.683594c2.175781-2.109375 3.042969-5.226563 2.277344-8.15625-.769531-2.929688-3.058594-5.21875-5.988281-5.988282-2.929688-.769531-6.046875.097657-8.15625 2.273438zm0 0" />
    ...
    <!-- Start of Faq Feed section
    	=============================================  -->
        <section id="sa_faq" class="sa_faq_feed_section inner-page-padding">
        <div class="container">
            <div class="sa_faq_content">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sa_faq_feed_img">
                    ...
                    <div class="col-lg-6">
                        <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Frequently Asked Question
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                            </div>
                        <div class="sa_faq_accordion">
                            <div class="accordion" id="accordionExample">
                                <div class="ei-faq faq_bg">
                                    <div class="ei-faq-header" id="headingOne">
                                        ...
                                        Is there any need for my ongoing business to use online marketing?
                                        </button>
                                    </div>
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        Everyday several users search on Google for their needs like hotels to stay, food to cook something new, best schools or universities, etc. If any user comes across your website, for sure it is going to increase your customer count and hence, grow branding too.
                                        </div>
                                    </div>
                                </div>
                                <div class="ei-faq">
                                    <div class="ei-faq-header" id="headingtwo">
                                        ...
                                        What is the mode of transaction being accepted? And when to pay the amount?
                                        </button>
                                    </div>
                                    <div id="collapsetwo" class="collapse" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        All the online transaction modes are accepted at NMPI digital marketing agency Dwarka. You have to pay full amount in advance and it is non-refundable once the service gets started as per the decided package.
                                        </div>
                                    </div>
                                </div>
                                <div class="ei-faq">
                                    <div class="ei-faq-header" id="headingthree">
                                        ...
                                        How do I contact you to achieve your service quote?
                                        </button>
                                    </div>
                                    <div id="collapsethree" class="collapse" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        Go to the Contact Us page of NMPI and from there, you can connect with our support executives to get further leads.
                                        </div>
                                    </div>
                                </div>
                            </div>
