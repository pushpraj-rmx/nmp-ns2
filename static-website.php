    ...
    <section id="crm-banner" class="crm-banner-section position-relative">
        ...
        <div class="container">
            <div class="crm-banner-content crm-headline pera-content position-relative">
                <span>Top Rated</span>
                <h1>Static Web Designing Company</h1>
                <p>
                    NMP provides the best static website designing services in Dwarka, Delhi. Our innovative web designers team recognize your business requirement and combine their technical information with their revolutionary ideas.
                </p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeFromUp;">
                        ...
                        <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>National Marketing Projects creates attractive and professional static websites according to the demand and needs of customers. The affordable cost of static web designing services helps you save your budget and with NMP designing experts this looks so easy.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="s2-feature_right">
                            <div class="s2-feature_list s2-grean wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Cost-Free Image Optimization</h3>
                                    <p>Your images are the main frontier of your website.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-purple wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Compatible Layout Website</h3>
                                    <p>Flash allows you to present your website with an extra interactive and expressive outlook.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-pink wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>The soul of your website must be perfect “quality content attracts the customers”.</p>
                                </div>
                            </div>
                            <!-- list item -->
                        </div>
                        ...
                        <div class="eg-funfact-text float-right wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Static Website 
                                    <span>Lets Rock you in the Market</span>
                                </h2>
                                <p>We, as the top-ranked static website design company in Dwarka, Delhi take responsibility for all your designing process and the method by which you can be the talk of the day among your customers.
                                </p>
                            </div>
                            <!-- /title -->
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        <p class="sub-heading">
                                            Customization As Client’s Need
                                        </p>
                                        Our experts make sure that the work we are doing should be as per your goals. Customers must be updated about the work and progress made till the last. We render you with the most affordable and low-cost static website designing services in Dwarka, Delhi.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                            Easy Website Navigation
                                        </p>
                                        Experts designers of the best and top-ranked static website development agency in Dwarka, Delhi build easier-to-use and user-friendly navigation for your customer's so that they can easily exceed all the things they want.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>Spending your budget on static website designing and having affordable static website service in Dwarka, Delhi with you lets you feel relaxed about your budget issues. We, NMP are a cost-efficient and as well as most trusted static website designing agency in the whole of Dwarka, Delhi.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        Cheap Static Website Development Company in Dwarka, Delhi provides low-cost and affordable prices that will help you in build more business.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Customers Engagements
                                        </p>
                                        Customers will surely be attracted by the designs static web design agency provides. They are shaped in a certain way where users feel attracted and can get all the information.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>NMP (National Marketing Projects, India) is Top Ranked Static web designing agency In Dwarka, Delhi. Our innovative ideas are just driven by exactly your needs. Having a friendly customer support team will enhance your mood while hiring us. We make sure that your website's chances of ranking at the top of the search engines will improve. Static websites are popular among start-ups as they contain the whole data and no need to update them regularly.</p>
                            </div>
                            <!-- <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="ei-faq">
                                    ...
                                    <div id="collapsetwo" class="collapse" data-parent="#accordionExample">
                                        <div class="ei-faq-body">
                                        All the online transaction modes are accepted at NMP digital marketing agency Dwarka. You have to pay full amount in advance and it is non-refundable once the service gets started as per the decided package.
                                        </div>
                                    </div>
                                </div>
                                <div class="ei-faq">
