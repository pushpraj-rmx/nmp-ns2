    ...
    <section id="crm-banner" class="crm-banner-section position-relative">
        ...
        <div class="container">
            <div class="crm-banner-content crm-headline pera-content position-relative">
                ...
                <p>Promoting brands on Social Media Platforms is a better choice when you have Best Social Media Marketing Agency in Dwarka, Delhi. We understand your requirements and help you attract potential buyers via it. If you want an expertise holding team for SMM services then feel free to connect with our experts.
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeFromUp;">
                        ...
                        <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>National Marketing Projects acquiring the position of Best SMM Agency in Dwarka, Delhi has an experienced team who 
                                    thinks a way ahead of market trends. We work with strategies that help you in Engaging Audience, Connect to Buyers, 
                                    and Growth of Business are:</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="s2-feature_right">
                            <div class="s2-feature_list s2-grean wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    ...
                                    <p>Becoming a soul of an advertising post helps customers to feel a connection with the brands. Be the talk of the day by flashing on the targeted audience’s screen.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-purple wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Improvised Creative</h3>
                                    <p>Users get your posts through the social media platform algorithm on the different social media platforms. We improvise them through good strategy.</p>
                                </div>
                            </div>
                            <!-- list item -->
                            <div class="s2-feature_list s2-pink wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeFromUp;">
                                ...
                                <div class="s2-feature_text_box saas2-headline pera-content">
                                    <h3>Analyzing the Trends and Competitors</h3>
                                    <p>We always take care of what is in trends that can boost your brand and where your competitors are heading to.</p>
                                </div>
                            </div>
                            <!-- list item -->
                        </div>
                        ...
                        <div class="eg-funfact-text float-right wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Professional Marketing Services 
                                    <span>to Uplift Your Business</span>
                                </h2>
                                <p>We, NMPI, offer the Best Social Media Marketing Service in Delhi, for the business that wants to get 
                                    the customers through Social Media Platforms. The team improves the quality of your social platforms 
                                    and runs them according to respective algorithms.
                                </p>
                            </div>
                            <!-- /title -->
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        NMPI expert SMM advertisers are capable of implementing an ad campaign that will help your business or as per your needs. 
                                        It is a little technical to get audiences with the help of this so many competitors don’t want to acknowledge it to the clients.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Selecting Platforms
                                        </p>
                                        Not all business is made for every social media platform. They don’t have the potential to drive an audience. So, our 
                                        experienced expert analysis is the perfect platform to drive your ads.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                ...
                                <p>Our experts will do marketing of your brands in a certain way that will build up your organic customers. Top Listed Social Media 
                                    Marketing (SMM) company in Dwarka, Delhi has experienced marketers assure you about gaining customers by making them your trusted repeated users.</p>
                            </div>
                            <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
                                        ...
                                        Best and affordable Social Media Marketing Company in Dwarka, Delhi hires professional and skilled team that will work on your social media marketing projects.
                                    </li>
                                    <li>
                                        <p class="sub-heading">
                                        Cost-Effective
                                        </p>
                                        Best SMM Agency in Dwarka, Delhi - NMPI take care of client’s budget and cost issues. We provide cost-effective and budget-friendly work. Our results are optimum expenses.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="app-edu-about-text">
                            <div class="eight-section-title appeight-headline pera-content text-left">
                                <span class="eg-title-tag" style="margin-left:50px;"> Fun facts
                                    <i class="square-shape"><i></i><i></i><i></i><i></i></i></span>
                                <h2>Why Choose NMPI for SMM Services?
                                    <span>Benefits of connecting NMPI</span>
                                </h2>
                                <p>NMPI - National Marketing Projects is the best choice of SMM services in Dwarka, Delhi. We understand your business and analyze it thoroughly. SMM Company in Dwarka understands the audience's needs and analyses the competitors. It creates content that is in trends and as per the likes and dislikes of your targeted audience. We execute the strategy by confirming and optimizing that and keep tracking performances.</p>
                            </div>
                            <!-- <div class="app-edu-about-list ul-li-block wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    <li>
